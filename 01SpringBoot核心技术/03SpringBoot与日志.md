...
```java
	...
	public void contextLoads() {
		...
		//可以调整输出的日志级别；日志就只会在这个级别以以后的高级别生效  logging.level.com.lgs=trace（配置文件中写入）
...
spring-boot-starter-logging**和**spring-boot-starter-log4j2进行**二选一**，如果使用spring-boot-starter-log4j2，则将spring-boot-starter-logging进行排除即可。
